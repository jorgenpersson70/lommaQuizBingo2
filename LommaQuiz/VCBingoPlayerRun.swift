//
//  VCBingoPlayerRun.swift
//  LommaQuiz
//
//  Created by jörgen persson on 2022-08-23.
//
...
class VCSeeBingoPlayerRun:  UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    ...
    let reuseIdentifierChart1 = "BingoChart1" // also enter this string as the cell identifier in the storyboard
    let reuseIdentifierChart2 = "BingoChart2"
    let reuseIdentifierChart3 = "BingoChart3"
    let reuseIdentifierPrev = "bingoPrev"
...
//    var testarna : [Int] = Array(repeating: 0, count: 17)
 ...
 //           prevNumbers[(questionnumberInt-1)*3+4] = ValueToPopUp2
   ...
   //             prevNumbers[(questionnumberInt-1)*3+4] = ValueToPopUp3
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if (collectionView == bingoChart1CV){
            ...
            let cell = bingoChart1CV.dequeueReusableCell(withReuseIdentifier: reuseIdentifierChart1, for: indexPath as IndexPath) as! CVCellBingoChart1
      ...
      //          if (i < 25)
            ...
            if (collectionView == bingoChart2CV){
                ...
                let cell2 = bingoChart2CV.dequeueReusableCell(withReuseIdentifier: reuseIdentifierChart2, for: indexPath as IndexPath) as! CVCellBingoChart2
   ...
   //                 cell2.backgroundColor = .yellow
         ...
         //           if ((i > 24) && (i < 50))
                ...
                if (collectionView == bingoChart3CV){
                    ...
                    let cell3 = bingoChart3CV.dequeueReusableCell(withReuseIdentifier: reuseIdentifierChart3, for: indexPath as IndexPath) as! CVCellBingoChart3
          ...
          //              cell3.backgroundColor = .green
              ...
              //      if ((i > 50) && (i < 75))
                    ...
                    let cell4 = bingoPrevCV.dequeueReusableCell(withReuseIdentifier: reuseIdentifierPrev, for: indexPath as IndexPath) as! CVCellBingoShowPrev
                    
                    if (prevNumbers[e] != 0){
                        cell4.showPrevValues.text = String(prevNumbers[e])
                    }
                    e += 1
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if (collectionView == bingoChart1CV){
            let cell = collectionView.cellForItem(at: indexPath) as! CVCellBingoChart1
            ...
            if ((cell.bingoChart1Label.text == showB.text) || (cell.bingoChart1Label.text == showI.text) || (cell.bingoChart1Label.text == showN.text) || (cell.bingoChart1Label.text == showG.text) || (cell.bingoChart1Label.text == showO.text)){
                ...
                for j in 0...35{
                    if (String(prevNumbers[j]) == cell.bingoChart1Label.text){
                        cell.backgroundColor = .systemGray
                        cellsThatAreGrayChart1[indexPath.row] = 1
                    }
                }
        ...
        if (collectionView == bingoChart2CV){
            let cell = collectionView.cellForItem(at: indexPath) as! CVCellBingoChart2
            ...
            if ((cell.bingoChart2Label.text == showB.text) || (cell.bingoChart2Label.text == showI.text) || (cell.bingoChart2Label.text == showN.text) || (cell.bingoChart2Label.text == showG.text) || (cell.bingoChart2Label.text == showO.text)){
                ...
                for j in 0...35{
                    if (String(prevNumbers[j]) == cell.bingoChart2Label.text){
                        cell.backgroundColor = .systemGray
                        cellsThatAreGrayChart2[indexPath.row] = 1
                    }
                }
        ...
        if (collectionView == bingoChart3CV){
            let cell = collectionView.cellForItem(at: indexPath) as! CVCellBingoChart3
            ...
            if ((cell.bingoChart3Label.text == showB.text) || (cell.bingoChart3Label.text == showI.text) || (cell.bingoChart3Label.text == showN.text) || (cell.bingoChart3Label.text == showG.text) || (cell.bingoChart3Label.text == showO.text)){
                ...
                for j in 0...35{
                    if (String(prevNumbers[j]) == cell.bingoChart3Label.text){
                        cell.backgroundColor = .systemGray
                        cellsThatAreGrayChart3[indexPath.row] = 1
                    }
                }
        ...
        if (collectionView == bingoPrevCV){
   //         let cell = collectionView.cellForItem(at: indexPath) as! CVCellBingoShowPrev
  //              cell.backgroundColor = .systemOrange
    ...
    func clearGrayCells(){
        ...
        prevNumbers = Array(repeating: 0, count: 36)
    }
  ...
  //      self.ref.child("BingoPlayerWinner").child(BingoName).child("TheWinner").setValue("Deltagare " + String(youAreplayer) + "har fått BINGO")
    ...
    func waitForChange() {
            ...
            self.ref.child("users").child("hej").child("billingUpdated").observeSingleEvent(of: .value) { (snapshot) in
